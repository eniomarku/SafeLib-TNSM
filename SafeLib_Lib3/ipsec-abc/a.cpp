...
void *action(void *arg) {
    ...
    string message = "This is a long message from A to B. Sent with lots of love.";
    ...
    while (true) {
        ...
        if (t == 1) {
            ...
            struct timeval tv1;
            tv1.tv_sec = 20; //timeout in seconds
            tv1.tv_usec = 0;
    ...
    // if (t != 0) lat = lat / t;
    spdlog::info("Measurement For {}: Latency={} Throughput={}", my_data->id, lat / t / 1000000000.0, t * 500 / my_duration);
    pthread_exit(NULL);
}
