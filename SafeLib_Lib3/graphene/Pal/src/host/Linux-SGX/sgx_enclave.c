...
#include <stdio.h>
int createServer_untrusted(void* lib_netmap_desc, char* ifname);
static long sgx_ocall_l3vnf_create_server(void *pms) {
    ms_ocall_l3vnf_create_server_t* ms = (ms_ocall_l3vnf_create_server_t*)pms;
    ODEBUG(OCALL_L3VNF_CREATE_SERVER, ms);
    
    createServer_untrusted(ms->ms_lib_netmap_desc, ms->ms_ifname);
...
sgx_ocall_fn_t ocall_table[OCALL_NR] = {
    ...
    // rider added 2021-8-4 for netmap control
    [OCALL_L3VNF_CREATE_SERVER] = sgx_ocall_l3vnf_create_server,
};
